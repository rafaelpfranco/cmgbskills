<?php
	...
	$area_acesso = "3";
	if(permisssao_acesso($_SESSION['us_id'],$area_acesso) == "F"){
	...
	$query = mysql_query("SELECT * FROM tbl_candidatura");
	
	while ($candidatura_table[] = mysql_fetch_array($query, MYSQLI_ASSOC)){}	

	$candidatura_table = array_slice($candidatura_table,0,-1);

	//return $candidatura_table;
