...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        ...
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Finalizado</h1>            
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="/">Painel</a></li>
              <li class="breadcrumb-item active">Finalizado</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
          		...
          		<div class="col-lg-12 col-12">
          			...
          			<div class="card">
						...
						<div class="card-header">
			            	<h3 class="card-title">LISTA DE TESTES FINALIZADOS</h3>
			            </div>
									...
									while($reg_lis_con = mysql_fetch_array($qry_lis_con)){
										...
										echo "<tr style='font-size: 14px;'>";
											...
											echo "<td align='center'>";											
												echo "<a href='index.php?pg=resultado-teste&id=".$id_candidato_teste."'><i class='far fa-check-circle'></i></a>";
											echo "</td>";
			            ...
			            <div class="card-body" style="font-size: 12px; border-top: 1px solid #ccc; text-align: right;">
			            	...
			            	<i class='far fa-check-circle' style="font-size: 12px; margin-left: 10px;"></i> resultado 
