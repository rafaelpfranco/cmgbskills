...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        ...
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Autorizar Teste</h1>            
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="/">Painel</a></li>
              <li class="breadcrumb-item"><a href="index.php?pg=aguardando">Aguardando Autorização</a></li>
              <li class="breadcrumb-item active">Autorizar Teste</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
    	...
    	<div class="container-fluid">
          	...
          	<div class="row">
          		<div class="col-lg-12 col-12">
          			...
          			<form id="LancamentoForm" method="post" role="form" action="autorizar-teste-process.php?ac=alterar" enctype="multipart/form-data">
