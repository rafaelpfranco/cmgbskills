<?php
	...
	if(isset($_SESSION['msg_desautoriza_teste'])){
		$msg_desautoriza_teste = $_SESSION['msg_desautoriza_teste'];
		unset($_SESSION['msg_desautoriza_teste']);
	}
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        ...
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Liberado</h1>            
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="/">Painel</a></li>
              <li class="breadcrumb-item active">Liberado</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
    ...
    <?php if(isset($msg_desautoriza_teste)): ?>
	<div class="alert alert-dismissable alert-success">
	  <button type="button" class="close" data-dismiss="alert">×</button>
	  <?php echo $msg_desautoriza_teste; ?>
	</div>
	<?php endif; ?>
          		...
          		<div class="col-lg-12 col-12">
          			...
          			<div class="card">
						...
						<div class="card-header">
			            	<h3 class="card-title">LISTA DE TESTES AGUARDANDO REALIZAÇÃO</h3>
			            </div>
			            ...
			            <div class="card-body">
			            	...
			            	<table id="example1" style="font-size: 10px !important;" class="table table-striped table-bordered table-hover" cellspacing="0" width="100%">
								...
								where
									(tbl_candidato_teste.situacao = 'LIBERADO' or
									tbl_candidato_teste.situacao = 'ANDAMENTO'
									)and 
										...
										echo "<tr style='font-size: 14px;'>";
											...
											echo "<td align='center'>";	
												if($situacao == "LIBERADO"){										
													echo "<a href='index.php?pg=desfazer-liberacao&id=".$id_candidato_teste."'><i class='fas fa-undo'></i></a>";
												}
											echo "</td>";
			            ...
			            <div class="card-body" style="font-size: 12px; border-top: 1px solid #ccc; text-align: right;">
			            	...
			            	<i class='fas fa-undo' style="font-size: 12px; margin-left: 10px;"></i> retornar 
