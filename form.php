<?php
	...
	$mensagemHTML = '
		...
		<div style="margin: 10px 200px;">
			...
			<p>Vaga: '.$vaga.'</p>
			<p>Menssagem: '.$messagem.'</p>
			<p>Currículo: <a href="https://app.cmgbskills.com.br/download/'.$nome.'" target="_blank">anexo</a></p>
		</div>
	';
	...
	header('Location: https://app.cmgbskills.com.br/form-modelo.php');
	exit;
